...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8] flex flex-col items-center relative overflow-hidden px-4 pt-10">
      ...
      {/* ── Book — right upper ── */}
      <svg className="pointer-events-none absolute right-2 top-1/4 w-36 h-40" style={{transform: "rotate(14deg)"}} viewBox="0 0 80 100" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg className="pointer-events-none absolute right-6 bottom-1/3 w-24 h-40" style={{transform: "rotate(-18deg)"}} viewBox="0 0 50 110" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* ── Mouse — bottom left ── */}
      <svg className="pointer-events-none absolute bottom-10 left-1/4 w-32 h-40" style={{transform: "rotate(15deg)"}} viewBox="0 0 70 100" xmlns="http://www.w3.org/2000/svg">
